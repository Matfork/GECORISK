...
<link rel="stylesheet" href="{{ url('assets/bower_components/datatables/media/css/jquery.dataTables.min.css') }}"></script>


<!-- JavaScript -->
<!-- General Javascript Constants -->
<script>
	var BASE_URL= "{{url('/')}}";
</script>
...
<script type="text/javascript" src="{{ url('assets/bower_components/datatables/media/js/jquery.dataTables.min.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/bower_components/handlebars/handlebars.min.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/js/build/main.min.js') }}"></script>
