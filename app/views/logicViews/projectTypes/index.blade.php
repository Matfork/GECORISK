...
@section('content')
    ...
    <h1>Project Types Module</h1>
     ...
     <div class="description_module">
        <h5>In the following tables you will see all the project types registered through the timelife of the application. <h5>
        <h5> Also as a user of GecoRisk you can create, update, delete the project types.</h5>
    </div>
