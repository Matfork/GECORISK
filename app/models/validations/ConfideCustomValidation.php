...
class ConfideCustomValidation implements UserValidatorInterface
{
      /**
    ...
    public function validate(ConfideUserInterface $user)
    {
        ...
        // Validate object
        $result = $this->validateAttributes($user, $this->rules) ? true : false;
     ...
     */
    public function validateAttributes(ConfideUserInterface $user, $rules)
    {
